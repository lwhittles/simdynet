...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in library("{}simdynet"{}): there is no package called 'simdynet'}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sim\_static\_sn(N = 1000, gamma = 1.8): could not find function "{}sim\_static\_sn"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(s\$dd, xlab = "{}"{}, ylab = "{}Degree distribution"{}, log = "{}xy"{}): object 's' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sim\_outbreak\_static\_sn(sn = s): could not find function "{}sim\_outbreak\_static\_sn"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sim\_outbreak\_static\_sn(N = 1000, gamma = 1.8): could not find function "{}sim\_outbreak\_static\_sn"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in hist(infs, xlab = "{}Time"{}, ylab = "{}Infections"{}, breaks = 20, main = "{}"{}): object 'infs' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sim\_dynamic\_sn(N = 1000, gamma = 1.8): could not find function "{}sim\_dynamic\_sn"{}}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in sim\_dynamic\_sn(N = 1000, gamma = 1.8, n\_infs = 1, beta = 2000): could not find function "{}sim\_dynamic\_sn"{}}}\end{kframe}
\end{knitrout}
